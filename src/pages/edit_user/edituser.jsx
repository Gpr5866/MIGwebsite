...
function Edituser() {
    ...
    async function handleSaveForm() {
        ...
        const result = await API.patch('/'+ idUser, {
            name: name,
            address: address,
            job_title: jobTitle,
                    ...
                    <div className="bottom">
                        ...
                        <div className="right">
                            <form>
                                ...
                                <div className="formInput">
                                    <label>Country</label>
                                    <select id="country" name="country" className='selectCountry' value={country} onChange={(e) => { setCountry(e.target.value) }}>
                                ...
                                <div className="formInput">
                                    <label>Status</label>
                                    <Switch checked={status} onClick={() => {setStatus(!status)}} inputProps={{ 'aria-label': 'controlled' }} />
                                </div>
                            </form>
                        </div>
                    </div>
                    <div className="buttonSave">
                        <Button variant='outlined' size='large' color='success' onClick={() => handleConfirmAlert()}>Save</Button>
                    </div>
                </div>
